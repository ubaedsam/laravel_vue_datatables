            ...
            <div class="d-flex">
                ...
                <div>
                    <div class="dropdown ml-4">
                        <button v-if="checked.length > 0" class="btn btn-secondary dropdown-toggle"
                        ...
                        <a href="#"
                            ...
                            class="dropdown-item" type="button" @click.prevent="deleteRecords"
                            v-if="checked.length > 0">
                            Delete
                        </a>

                        <a :href="url" class="dropdown-item" v-if="checked.length > 0" type="button">
                            Export
                        </a>
                        <!-- </div> -->
                    </div>
                ...
                <tbody>
                    ...
                    <tr v-for="student in students.data" :key="student.id"
                        ...
                        <td>
                            <button
                                onclick="confirm('Are you sure you wanna delete this Record?') || event.stopImmediatePropagation()"
                                class="btn btn-danger btn-sm" @click="deleteSingleRecord(student.id)">
